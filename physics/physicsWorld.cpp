...
void PhysicsWorld::init() {
    ...
    cubeBox = physicsCommon.createBoxShape(rp3d::Vector3(1.0, 1.0, 1.0));
    ...
    cube = createPhysicsObj(reactphysics3d::Vector3(3.0,1.8,-15.0), cubeBox, reactphysics3d::BodyType::STATIC);
